...
export default defineNuxtConfig({
  ...
  // Security headers on every response (CSP allows the inline JSON-LD + hydration payload)
  routeRules: {
    '/**': {
      headers: {
